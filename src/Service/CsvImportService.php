...
class CsvImportService
{
     ...
     *
     * @throws \RuntimeException Si hay error al procesar el archivo
     */
     ...
     * Retorna true si fue importada, false si es duplicado.
     *
    ...
    /**
     * Elimina BOM UTF-8 del inicio del contenido.
     */
    ...
    /**
     * Parsea contenido CSV detectando delimitadores (coma o punto y coma).
     */
